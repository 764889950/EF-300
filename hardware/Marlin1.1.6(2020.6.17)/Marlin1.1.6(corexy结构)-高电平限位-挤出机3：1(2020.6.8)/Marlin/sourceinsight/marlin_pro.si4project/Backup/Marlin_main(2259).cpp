...
#define pin_broadcast 7  //新增，作用于MKS BASE D7引脚（E1)
...
//          digitalWrite(HEATER_1_PIN,HIGH);
          //SERIAL_PROTOCOLPGM("HEATER_1_PIN,HIGH");
//          delay(5000);
//          digitalWrite(HEATER_1_PIN,LOW);
          //SERIAL_PROTOCOLPGM("HEATER_1_PIN,LOW");
//          SET_OUTPUT(HEATER_1_PIN);
//          OUT_WRITE(HEATER_1_PIN,HIGH);
        }
//                  pinMode(HEATER_1_PIN,OUTPUT);
//          digitalWrite(HEATER_1_PIN,HIGH);
//        thermalManager.setTargetHotend(205,HEATER_2_PIN);
        pinMode(HEATER_1_PIN,OUTPUT);
        digitalWrite(HEATER_1_PIN,LOW);
        gcode_M18_M84();
        print_end_flag=0;
